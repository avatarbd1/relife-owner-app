...
const OWNER: MenuSection[] = [
  {
    ...
    items: [
      ...
      { label: "🗑️ আজকের এন্ট্রি মুছুন", href: "/corrections", note: "Own same-day correction + audit" },
...
const RECEPTIONIST: MenuSection[] = [
  {
    ...
    items: [
      ...
      { label: "🗑️ আজকের এন্ট্রি মুছুন", href: "/corrections", note: "Own same-day correction" },
