  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        {salary.excessPaid > 0 && <p className="mt-2 rounded-lg bg-amber-50 px-3 py-2 text-[11px] leading-4 text-amber-800">Ledger paid exceeds this month’s commitment by {formatBDT(salary.excessPaid)}. Current 13_Salary rows do not contain a Salary/Advance type field, so the excess is not auto-classified.</p>}
